  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="bg-[#574529] text-gray-100 py-3 px-6 text-lg font-sans rounded-lg transition-opacity hover:opacity-90 disabled:bg-slate-500 disabled:opacity-50 sm:w- md:w-72"
      >
        Send message
      </button>
    </form>
